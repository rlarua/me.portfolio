...
const ReadmeModal = ({ isOpen, onClose }) => {
  const SparkleMotion = motion.div;
          ...
          <div className="p-4 md:p-12 max-w-full">
            <div className="markdown-content break-words max-w-full">
              <ReactMarkdown
                ...
                components={{
                  h1: ({ ...props }) => <h1 className="text-3xl font-black text-slate-900 mb-8 tracking-tight" {...props} />,
                  h2: ({ ...props }) => <h2 className="text-2xl font-black text-slate-900 mt-12 mb-6 pb-3 border-b border-slate-100 tracking-tight" {...props} />,
                  h3: ({ ...props }) => <h3 className="text-xl font-bold text-slate-900 mt-8 mb-4 tracking-tight" {...props} />,
                  ...
                  ul: ({ ...props }) => <ul className="list-disc list-outside ml-6 mb-8 space-y-3 text-slate-600" {...props} />,
                  ol: ({ ...props }) => <ol className="list-decimal list-outside ml-6 mb-8 space-y-3 text-slate-600" {...props} />,
                  li: ({ ...props }) => <li className="pl-2" {...props} />,
                  a: ({ ...props }) => <a className="text-blue-600 font-bold hover:underline transition-all" target="_blank" rel="noopener noreferrer" {...props} />,
                  table: ({ ...props }) => (
                    <div className="overflow-x-auto my-10 rounded-2xl border border-slate-100 shadow-sm">
                      <table className="w-full text-left border-collapse" {...props} />
                    </div>
                  ),
                  thead: ({ ...props }) => <thead className="bg-slate-50 border-b border-slate-100" {...props} />,
                  th: ({ ...props }) => <th className="p-4 text-sm font-black text-slate-900 uppercase tracking-wider" {...props} />,
                  td: ({ ...props }) => <td className="p-4 text-sm text-slate-600 border-b border-slate-50" {...props} />,
                  hr: ({ ...props }) => <hr className="my-12 border-slate-100" {...props} />
                }}
              >
                {readmeContent}
              </ReactMarkdown>
